...
import { colorApp, settingApp, Component, lang, Icon, Utils } from "public";
...
const Item = memo((props) => {
    const { obj, onDelete, onUpdateItem, gotoDetail } = props || {};
            ...
            <View style={styles.view_content}>
                ...
                <View style={styles.view_price}>
                    ...
                    <Text style={styles.txt_price}>
                        {Utils.formatMoney(dataItem?.price_cost) || lang.emptyText}
                    </Text>
                </View>
