...
export default function ModalUpdate(props) {
    ...
    let _onChangeTextDebounce = debounce(_onChangeText, 500)
    ...
    async function _onSave() {
        ...
        const result = await validateApi(props?.dataUpdate?.id || null, body)
    ...
    async function validateApi(id, body) {
        if (props?.dataUpdate?.id) {
            return await ApiCall.updateManufact_Group(id, body)
        }
        else {
